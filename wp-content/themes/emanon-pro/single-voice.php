...
<?php // 投稿ページレイアウトの表示判定
	...
	if ( $single_layout_type == 'right_sidebar') {
		get_template_part( 'blog-templates/single/right-sidebar-single-voice' );
	}
	elseif ( $single_layout_type == 'left_sidebar' ) {
		get_template_part( 'blog-templates/single/left-sidebar-single-voice' );
	}
	elseif ( $single_layout_type == 'no_sidebar' ) {
	 get_template_part( 'blog-templates/single/no-sidebar-single-voice' );
	}
?>
